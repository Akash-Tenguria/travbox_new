...
<i class="fa fa-briefcase" aria-hidden="true"></i> <?php echo $cB; ?></div> <div class="bookmsg"> 
 ...
 <td width="20%" align="center" style="font-size:20px; font-weight:800;">&#8377; <?php $totalfare=0; echo $totalfare=$basefares[1]+$flightprice['agentFixedMakup']; ?> 
	...
	$sellingfare=0;
	 ...
	 echo round($totalfare-$sellingfare); ?></span></span></div>
